...
def payitforward():
	...
	r = requests.post('https://api.postmates.com/v1/customers/'+ str(os.environ.get('PMATES_CUSTOMERID')) +'/deliveries', data = data, auth=HTTPBasicAuth(os.environ.get('PMATES_TESTAPIKEY'), ''))
	#print r.content
